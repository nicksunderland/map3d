#ifndef CCMAPWINDOW_H
#define CCMAPWINDOW_H
...
class CCMapWindow: public Map3dGLWidget
{
public:
    Q_OBJECT;
public:
  CCMapWindow(QWidget* parent);
  static CCMapWindow* CCMapWindowCreate(int _width, int _height, int _x, int _y);
