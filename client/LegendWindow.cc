...
void LegendWindow::paintGL()
{
  ...
  if (mesh->gpriv->showinfotext) {
    ...
    */
    ...
    //std::cout<<"user_scaling value is " <<cursurf->user_scaling<<std::endl;
    ...
    else if (scope == GLOBAL_GLOBAL_USER_DEFINE && map3d_info.global_user_potmin < map3d_info.global_user_potmax){
       toRender = "User-specified global";
    }
