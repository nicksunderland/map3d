#ifndef RMSEMAPWINDOW_H
#define RMSEMAPWINDOW_H
...
class RMSEMapWindow: public Map3dGLWidget
{
public:
    Q_OBJECT;
public:
  RMSEMapWindow(QWidget* parent);
  static RMSEMapWindow* RMSEMapWindowCreate(int _width, int _height, int _x, int _y);
