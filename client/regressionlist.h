...
const char *menulist[] = { "",
		     ...
		     "scaling_global_global", "scaling_local", "scaling_function_linear","toggle_nearest_electro",
		     ...
		     "mesh_render_none", "mesh_render_connectivity", "mesh_render_points", "mesh_color", "mesh_toggle",
		     "mesh_render_points_connectivity",
		     "mesh_render_elements_connectivity", "mesh_render_nondata_elements", "secondary_color", "mesh_disp_lwindow",
		     "mesh_geom_reload","mesh_data_reload","mesh_both_reload","mesh_file_dialog",
		     ...
		     "pick_mean_reference","pick_clear_reference","mark_all_aphere_value",
		     ...
		     "mark_toggle", "graphics_light_above", "graphics_light_below", "graphics_light_left", "graphics_light_right", "mark_all_activation_value","mark_all_activation_node",
         "graphics_light_front", "graphics_light_back", "graphics_light_none", "graphics_fog", "graphics_fog_adjust","graphics_cont_smoothing",
		     ...
		     "window_save_transform", "window_lwindow_show", "window_lwindow_show", 
		     "window_meshaxes", "window_winaxes", "clip_front", "clip_back", "clip_together", "clip_with_object",
		     "frame_lock","transparent_point", "trans_lock", "frame_reset","frame_dialog","frame_step_1", "frame_step_2", "frame_step_4",
		     ...
		     "no_fid_map", "act_fid_map", "rec_fid_map","fid_map_shade_toggle", "fid_draw_fid",
		     NULL
};
//#endif
