...
#define DEF_MESH_RED 0
#define DEF_MESH_GREEN 0
#define DEF_MESH_BLUE 0
#define DEF_SHADINGMODEL SHADE_GOURAUD
#define DEF_DRAWMESH RENDER_MESH_NONE
...
#define DEF_AXES_COLOR_RGB 0

#define DEF_TRANSPARENT false /*Shu Meng*/
